...
| [Syntax & Configuration](#syntax-and-configuration) | Basic syntax, configuration options |
...
| **Mindmap, Gantt, Pie, etc.** | See full list in docs |
...
Below are complete, runnable examples for each diagram type.  
Copy the code into a file with a `.md` extension or a `<pre class="mermaid">` block and open it in a Mermaid‑enabled viewer.
