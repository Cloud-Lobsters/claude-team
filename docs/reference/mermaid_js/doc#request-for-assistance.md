...
| Section | Description |
|--------|------------|
| [Getting Started](#getting-started) | Install, configure, and render a diagram |
...
| [API Usage](#api-usage) | How to embed Mermaid in a page |
...
```html
<!-- Example: Render a diagram on page load -->
<script type="module">
...
> All examples below are wrapped in a `<pre class="mermaid">` block when used in HTML.
...
> Replace `<version>` with the desired release number (e.g., `11`).
...
Mermaid sanitizes diagram code to prevent malicious scripts.  
...
See the full [contribution guide](https://github.com/mermaid-js/mermaid/blob/main/CONTRIBUTING.md).
...
- **General**: `issues@mermaid.live`

---

*Mermaid was created by Knut Sveidqvist. It is maintained by a community of contributors.*