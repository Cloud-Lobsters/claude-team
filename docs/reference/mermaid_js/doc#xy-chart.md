...
Copy the code blocks into a file with a `.mmd` extension or paste them into a Mermaid‑enabled editor.
...
> **Note:** Interactive features may be limited in sandbox mode.
...
Send an email to `security@mermaid.live` with:
...
- **D3** & **dagre-d3** – layout & drawing libraries  
- **js-sequence-diagram** – sequence grammar  
- **Jessica Peter** – Gantt inspiration  
- **Tyler Long** – long‑term collaboration  

---

*This documentation is a sanitized, code‑centric reference for Mermaid users and contributors.*