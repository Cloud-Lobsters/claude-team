...
- When prerendering, avoid using `<a href="/auth/signin">` links; use the provided components or client‑side functions instead.
...
> Use `customFetch` only when necessary (e.g., corporate proxies, testing).
