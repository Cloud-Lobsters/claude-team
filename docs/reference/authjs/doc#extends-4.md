...
> On Vercel you can generate one with `openssl rand -hex 32` or use the online generator: https://generate-secret.vercel.app/32.
...
## 11. Custom Fetch (Corporate Proxy)
...
## 12. API Reference – `SvelteKitAuth`
...
6. Protect routes with page loads or a custom handle hook.  
