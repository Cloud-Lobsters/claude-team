...
| `User` | User profile returned by OAuth provider. |
...
> **Caution** – Overriding `customFetch` can introduce security risks. Use only when necessary (e.g., corporate proxies, testing).
